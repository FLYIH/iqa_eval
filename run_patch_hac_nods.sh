...
#SBATCH --job-name=patch_hac_nods
#SBATCH --partition=8gpus
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:1
#SBATCH --output=/home/u4546465/iqa_eval/logs/patch_hac_nods-%j.out
#SBATCH --error=/home/u4546465/iqa_eval/logs/patch_hac_nods-%j.err
